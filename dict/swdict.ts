...
function createBaseSortalike(): Sortalike {
  return { subwords: [] };
}

export const Sortalike: MessageFns<Sortalike> = {
  encode(message: Sortalike, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.subwords) {
      writer.uint32(10).string(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Sortalike {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSortalike();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.subwords.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Sortalike {
    return {
      subwords: globalThis.Array.isArray(object?.subwords) ? object.subwords.map((e: any) => globalThis.String(e)) : [],
    };
  },

  toJSON(message: Sortalike): unknown {
    const obj: any = {};
    if (message.subwords?.length) {
      obj.subwords = message.subwords;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Sortalike>, I>>(base?: I): Sortalike {
    return Sortalike.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Sortalike>, I>>(object: I): Sortalike {
    const message = createBaseSortalike();
    message.subwords = object.subwords?.map((e) => e) || [];
    return message;
  },
};
...
export const Metadata: MessageFns<Metadata> = {
  encode(message: Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.sortalikes) {
      Sortalike.encode(v!, writer.uint32(66).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.sortalikes.push(Sortalike.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Metadata {
    return {
      ...
      sortalikes: globalThis.Array.isArray(object?.sortalikes)
        ? object.sortalikes.map((e: any) => Sortalike.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: Metadata): unknown {
    ...
    if (message.sortalikes?.length) {
      obj.sortalikes = message.sortalikes.map((e) => Sortalike.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Metadata>, I>>(object: I): Metadata {
    ...
    message.sortalikes = object.sortalikes?.map((e) => Sortalike.fromPartial(e)) || [];
    return message;
  },
};
...
function createBaseLexicon(): Lexicon {
  return { metadata: undefined, data: new Uint8Array(0) };
}
